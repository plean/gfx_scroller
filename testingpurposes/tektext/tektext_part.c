...
** Last update Sun Mar 20 22:14:57 2016 Michel Mancier
*/
...
{
  static t_bunny_position	pos1 = {10, 10};
  ...
  //  pos1.x += 1;
  //pos1.y = (int)((HEIGHT >> 1) + ((HEIGHT >> 1) * (cos(pos1.x * 0.1))) / 2);
  tektext_part(prog->pix, "Keur. <3.", font, &pos1);
}
